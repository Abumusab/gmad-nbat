...
public class num6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p6ad1 = (Button) findViewById(R.id.p6addone);
        p6ad5 = (Button) findViewById(R.id.p6addfive);
        p6ad10 = (Button) findViewById(R.id.p6addten);
        p6su1 = (Button) findViewById(R.id.p6subone);
        p6su5 = (Button) findViewById(R.id.p6subfive);
        p6su10 = (Button) findViewById(R.id.p6subten);
        p6num = (TextView) findViewById(R.id.player6num);
        ...
        p6ad1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                p6re++;
                p6num.setText(Integer.toString(p6re));

            }


        });
        p6ad5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                p6re++;
                p6re++;
        ...
        p6ad10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                p6re++;
                p6re++;
        ...
        p6su1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                p6re--;
                p6num.setText(Integer.toString(p6re));
        ...
        p6su5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                p6re--;
                p6re--;
        ...
        p6su10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                p6re--;
                p6re--;
